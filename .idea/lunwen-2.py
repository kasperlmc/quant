...
<html>
  <head>
    ...
    <title>改革开放以来中国老年社会保障制度的发展变革及政策思考 - 中国知网
        </title>
  ...
  <body><script type="text/javascript" src="http://piccache.cnki.net/kdn/KCMS/detail/js/min/WideScreen.min.js"></script><input id="loginuserid" type="hidden" value="WEEvREcwSlJHSldRa1FhcTdWZDhMQ0QxSjZrZ1p5WGsyazF1c0RsUm9lZz0=$9A4hF_YAuvQ5obgVAqNKPCYcEjKensW4ggI8Fm4gTkoUKaID8j8gFw!!"><input id="listv" type="hidden" value=""><input id="deliveryType" type="hidden" value=""><input id="deliveryUid" type="hidden" value=""><input id="deliveryUname" type="hidden" value=""><input id="deliveryCoutent" type="hidden" value="#"><input id="deliveryTable" type="hidden" value=""><input id="SingePointShow" type="hidden" value=""><script type="text/javascript" src="http://piccache.cnki.net/kdn/kns/script/jQuery-1.11.3.min.js"></script><script type="text/javascript" src="&#xA;        http://login.cnki.net/TopLogin/api/loginapi/get?type=top&amp;localCSS=&amp;returnurl=http%3a%2f%2fkns.cnki.net%2fKCMS%2fdetail%2fdetail.aspx%3fdbcode%3dCJFQ%26dbname%3dCJFD2009%26filename%3dRKYZ200902004%26uid%3dWEEvREcwSlJHSldRa1FhcTdWZDhMQ0QxSjZrZ1p5WGsyazF1c0RsUm9lZz0%3d%249A4hF_YAuvQ5obgVAqNKPCYcEjKensW4ggI8Fm4gTkoUKaID8j8gFw!!%26v%3dMTU2ODdTN0RoMVQzcVRyV00xRnJDVVJMMmVaZVptRmlIbFU3dklOeWJTZExHNEh0ak1yWTlGWUlSOGVYMUx1eFk%3d"></script><div id="headerBox"></div>
    <div class="line-box">
      ...
      submitSearch();
    ...
    </script><script>$("#catalog_Ptitle").html("期刊");</script><div class="wxside">
        <div id="CatalogSide" class="wxside kcmsCatalog">
          ...
          <div class="clBd">
            ...
            <dl>
              <dt id="lcatalog_divzqcl" class="leftBar_Img" style="display:none;" onclick="TurnToTitle('catalog_divzqcl')"><a><i></i>增强材料
              </a></dt>
            </dl>
          </div>
          <div class="clHd">
      ...
      <input id="catalogIds" type="hidden" value=""></div>
          <div class="clBd">
            <dl>
              <dt id="lcatalog_ref" onclick="TurnToTitle('catalog_ref')"><a><i></i>引文网络
              </a></dt>
            </dl>
            <dl>
              <dt id="lcatalog_func601" onclick="GetAndShowFiles(this);"><a><i></i>关联作者
          </a></dt>
            </dl>
            <dl>
              <dt id="lcatalog_func604" onclick="GetAndShowFiles(this);"><a><i></i>相似文献
          </a></dt>
            </dl>
            <dl>
              <dt id="lcatalog_func605" onclick="GetAndShowFiles(this);"><a><i></i>读者推荐
          </a></dt>
            </dl>
            <dl style="display:none;">
              <dt id="lcatalog_func602" onclick="GetAndShowFiles(this);"><a><i></i>主题指数
          </a></dt>
            </dl>
            <dl>
              <dt id="lcatalog_func603" onclick="GetAndShowFiles(this);"><a><i></i>相关基金文献
              </a></dt>
            </dl>
          </div>
        </div>
      ...
      <div class="wxmain">
        <div class="wxTitle">
          <h2 class="title">改革开放以来中国老年社会保障制度的发展变革及政策思考</h2><a class="btn-note" target="_blank" href="http://x.cnki.net/search/common/testlunbo?dbcode=CJFD&amp;tablename=CJFD2009&amp;filename=RKYZ200902004&amp;filesourcetype=1"><img src="resource/gb/images/note-btn.gif"></a><div class="author"><span><a onclick="&#xA;                    TurnPageToKnet('au','姜向群','');&#xA;                  ">姜向群</a></span></div>
          <div class="orgn"></div>
    ...
    </a><span id="AttentionYes" style="display:none;" class="followtop"><a class="icon icon-followSuccess" title="可以去 我的关注 查看更新" target="mycnkitarget" href="http://kns.cnki.net/knsdelivery/mycnki.aspx?uid=WEEvREcwSlJHSldRa1FhcTdWZDhMQ0QxSjZrZ1p5WGsyazF1c0RsUm9lZz0=$9A4hF_YAuvQ5obgVAqNKPCYcEjKensW4ggI8Fm4gTkoUKaID8j8gFw!!&amp;type=2&#xA;                    "><i></i>已关注       
      </a></span><span class="followtop" id="AttentionNo" style="position:relative;"><a class="icon icon-follow" title="关注文献" href="javascript:void(0);" onclick="AttentionServiceParam('2', 'WEEvREcwSlJHSldRa1FhcTdWZDhMQ0QxSjZrZ1p5WGsyazF1c0RsUm9lZz0=$9A4hF_YAuvQ5obgVAqNKPCYcEjKensW4ggI8Fm4gTkoUKaID8j8gFw!!','CJFD2009','RKYZ200902004','0');"><i></i>关注
      </a><div class="popflow" id="popupTips" style="display:none;">
                <div class="popflowArr"></div>
                <div class="popflowCot">
                  <div class="hd"><a href="javascript:void(0);" onclick="$('#popupTips').hide();$('#popupmsg').html('')" class="close">X</a></div>
                  <div class="bd">
                    <p class="mes" id="popupmsg" name="popupmsg">关注成功！</p>
                    <p class="des">
              加关注后您将方便地在 <a target="_mycnki" href="http://kns.cnki.net/knsdelivery/mycnki.aspx?uid=WEEvREcwSlJHSldRa1FhcTdWZDhMQ0QxSjZrZ1p5WGsyazF1c0RsUm9lZz0=$9A4hF_YAuvQ5obgVAqNKPCYcEjKensW4ggI8Fm4gTkoUKaID8j8gFw!!&amp;type=2">
                我的关注
              </a> 中得到本文献的被引频次变化的通知！
            </p>
                  </div>
                  <div class="ft"><a class="extra" title="订阅" href="javascript:void(0);" onclick="SubScription('2', 'WEEvREcwSlJHSldRa1FhcTdWZDhMQ0QxSjZrZ1p5WGsyazF1c0RsUm9lZz0=$9A4hF_YAuvQ5obgVAqNKPCYcEjKensW4ggI8Fm4gTkoUKaID8j8gFw!!', 'CJFD2009|');">
              你还可以通过其他方式得到推送信息&gt;&gt;
            </a></div>
                </div>
              </div><script>
      ...
      </script></span><span class="shareBoard" onmouseover="$('#sharedet').show();$('#this').addClass('shareBoardCUR')" onmouseout="$('#sharedet').hide();$('#this').removeClass('shareBoardCUR')"><a class="icon icon-share" href="#"><i></i>分享<em></em></a><script> document.write(ShareAstr('shareHide'));</script></span><a class="icon icon-favor" title="收藏" href="javascript:void(0);" onclick="AddFavTitle('')"><i></i>收藏
    </a><a class="icon icon-print" href="javascript:void(0);" onclick="window.print();"><i></i>打印
    </a><a class="icon icon-comment" title="评论" href="#" style="display:none;"><i></i>评论
    </a><span class="otherversions" style="display:none"></span></div>
        </div>
        <div id="datapupart"></div>
        <div class="wxInfo">
          <div class="wxBaseinfo">
            <p><label id="catalog_ABSTRACT">摘要：</label><span id="ChDivSummary" name="ChDivSummary">老年社会保障制度的变革成为我国改革开放以来社会制度变革的一个重要方面。本文探讨了我国城镇养老保险制度的改革、农村社会养老保险制度试行过程及内容,回顾了老年救济和老年福利政策,指出这些措施对于保证广大老年人的基本生活需要,实现老有所养的目标,适应人口老龄化的快速发展,维护社会稳定和加快社会建设起到了重要作用。本文也提出,随着社会经济的不断发展,老年社会保障制度中的新问题也不断暴露出来,需要开展深入研究和适时做出政策调整,以利于我国老年社会保障事业的发展,促进全面小康社会的实现。本文还对中国改革开放以来城乡老年社会保障制度的发展改革效果上给以分析和评价,指出当前存在的主要问题,并提出增加政府责任等进一步发展的对策思考。</span><span><a id="ChDivSummaryMore" onclick="MoerSummary('ChDivSummary','ChDivSummaryMore','ChDivSummaryReset')" style="display:none">更多</a><a id="ChDivSummaryReset" onclick="ResetSummary('ChDivSummary','ChDivSummaryMore','ChDivSummaryReset')" style="display:none">还原</a></span><br></p><script type="text/javascript">
      AbstractFilter('ChDivSummary','ChDivSummaryMore','ChDivSummaryReset');
    </script><p><label id="catalog_KEYWORD">关键词：</label><a onclick="&#xA;                      TurnPageToKnet('kw','改革开放','')&#xA;                    ">改革开放;
                  </a><a onclick="&#xA;                      TurnPageToKnet('kw','老年社会保障','')&#xA;                    ">老年社会保障;
                  </a><a onclick="&#xA;                      TurnPageToKnet('kw','社会养老保险','')&#xA;                    ">社会养老保险;
                  </a></p>
            <p><label id="catalog_ZTCLS">分类号：</label>F842.6</p>
        ...
        PDF下载
            ...
            <div class="dllink-down">
              <div class="info">
                <div class="total"><span class="a"><label>下载：</label><b>2271</b></span><span class="h"><label>页码：</label><b>20-31</b></span><span class="h"><label>页数：</label><b>12</b></span><span class="h"><label>大小：</label><b>263K</b></span></div>
              ...
              <div class="qr-code"><img alt="" src="http://app.cnki.net/Parts/QRCode/Get?source=KCMS&amp;text=http%3a%2f%2fm.cnki.net%2fcnkiday%2fappdownzwj.html%3ftype%3dCJFD%26id%3dRKYZ200902004"><p class="text"><b>手机阅读本文</b><span>下载安装手机APP</span><span>扫码同步阅读本文</span></p><i class="icon-trangle"></i><div class="tip-pop">
                  <div class="inner">
                    <h6>即刻使用手机阅读</h6>
                    <div class="f-left first"><img alt="" src="/kcms/Detail/resource/gb/images/icon-qrcode-download.jpg"><span>第一步</span><p>扫描二维码下载</p>
                      <p>"移动知网-全球学术快报"客户端</p>
                    </div>
                    <div class="f-left second"><img alt="" src="/kcms/Detail/resource/gb/images/icon-pop-sample.jpg"><span>第二步</span><p>打开“全球学术快报”</p>
                      <p>点击首页左上角的扫描图标</p>
                    </div>
                    <div class="f-left third"><img alt="" src="http://app.cnki.net/Parts/QRCode/Get?source=KCMS&amp;text=http%3a%2f%2fm.cnki.net%2fcnkiday%2fappdownzwj.html%3ftype%3dCJFD%26id%3dRKYZ200902004"><span>第三步</span><p>扫描二维码</p>
                      <p>手机同步阅读本篇文献</p>
                    </div>
                  </div>
                </div>
          ...
          <div class="wxsour">
            ...
            <div class="sourinfo">
              <p class="title"><a onclick="getKns55NaviLink('WEEvREcwSlJHSldRa1FhcTdWZDhMQ0QxSjZrZ1p5WGsyazF1c0RsUm9lZz0=$9A4hF_YAuvQ5obgVAqNKPCYcEjKensW4ggI8Fm4gTkoUKaID8j8gFw!!','CJFQ','CJFQbaseinfo','RKYZ');">人口研究</a></p>
              ...
              <p><a onclick="getKns55NaviLinkIssue('WEEvREcwSlJHSldRa1FhcTdWZDhMQ0QxSjZrZ1p5WGsyazF1c0RsUm9lZz0=$9A4hF_YAuvQ5obgVAqNKPCYcEjKensW4ggI8Fm4gTkoUKaID8j8gFw!!','CJFQ','CJFQyearinfo','RKYZ','2009','02')">2009年02期
                </a></p>
              <p>
                  ISSN：1000-6087</p>
    ...
    <div class="fixedbar">
      <div class="adviceside"><a class="fixCon" target="_blank" href="http://help.cnki.net/">在线咨询</a><a target="_blank" class="fixFed" href="http://kns.cnki.net/knsvote/vote.aspx">
          用户反馈
        </a></div>
